        ...
        <div className="col-md-6 col-lg-4 mb-4">
            <div className="property-entry h-100">
                <a href="property-details.html" className="property-thumbnail">
                    ...
                    <img src="assets/images/img_1.jpg" alt="hanh" className="img-fluid"/>
                </a>
                <div className="p-4 property-body">
                    <span className="property-favorite"><span className="icon-heart-o"/></span>
                    ...
                    <span className="property-location d-block mb-3"><span
                        className="property-icon icon-room"/> 625 S. Berendo
